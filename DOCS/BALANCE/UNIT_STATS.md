...
| 기사 (knight) | 130 | 13 | 40 | 45 | 1200 | 15 | 20 | X | — |
| 성기사 (paladin) | 180 | 16 | 50 | 45 | 1300 | 16 | 30 | X | isPaladin, auraRadius: 100 |
...
- **기사 (knight)**: 고HP 근접 유닛. 느리지만 적 유닛을 오래 붙잡는 역할.
- **성기사 (paladin)**: 근접 전투 유닛 겸 버프 제공자. 반경 100px 내 아군에게 ATK+20%, 피해 감소 10% 버프를 제공. 오라 버프는 최대 3스택 중첩된다.
